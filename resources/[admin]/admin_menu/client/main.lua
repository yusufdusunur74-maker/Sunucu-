...
function OpenAdminMenu()
    ...
    print("^2✓^7 Mülk & Maaş Yönetimi")
    print("^2✓^7 Birlik Yönetimi")
    print("^1║ Komutlar:                              ║^7")
    print("^3/givehouse [playerId] [houseId]^7 - Ev ver")
    print("^3/removehouse [houseId]^7 - Ev sahipliğini kaldır")
    print("^3/houseinfo [houseId]^7 - Ev sahibi göster")
    print("^3/setsalary [playerId] [amount]^7 - Oyuncu maaşını ayarla")
    print("^3/getsalary [playerId]^7 - Oyuncu maaşını göster")
    print("^3/setjobpay [job] [amount]^7 - Meslek kazancını ayarla (server) ")
    print("^3/createunion [name]^7 - Birlik oluştur")
    print("^3/deleteunion [name]^7 - Birlik sil")
    print("^3/unionadd [name] [playerId]^7 - Birliğe üye ekle")
    print("^3/unionremove [name] [playerId]^7 - Birlikten çıkar")
    print("^3/unioninfo [name]^7 - Birlik bilgisi")
    print("^3/setunionincome [name] [amount]^7 - Birlik gelirini ayarla")
    print("^1║                                        ║^7")
    print("^1║ Komutlar:                              ║^7")
